...
describe("MessageList", () => {
    ...
    it("renders typing dots animation when loading", () => {
        render(<MessageList messages={[]} isLoading={true} autoScroll={true} onScrollToTop={mockOnScrollToTop} />);
    ...
    it("handles empty messages array gracefully", () => {
        render(<MessageList messages={[]} isLoading={false} autoScroll={false} onScrollToTop={mockOnScrollToTop} />);
    ...
    describe("History loading", () => {
        ...
        it("does not call onScrollToTop when no messages exist", async () => {
            const { container } = render(
                <MessageList messages={[]} isLoading={false} autoScroll={true} onScrollToTop={mockOnScrollToTop} />,
            );
