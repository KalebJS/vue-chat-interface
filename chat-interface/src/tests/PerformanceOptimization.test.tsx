...
describe('Performance Optimizations', () => {
  ...
  describe('LazyLangChainService', () => {
    ...
    it('should handle initialization errors gracefully', async () => {
      ...
      // Mock the LangChainService constructor to throw an error
      const mockLangChainService = {
        initialize: vi.fn().mockRejectedValue(new Error('Failed to load LangChainService')),
        isInitialized: vi.fn().mockReturnValue(false),
        sendMessage: vi.fn().mockRejectedValue(new Error('Service not initialized'))
      };
      
      // Replace the internal service with our mock before calling init
      (service as any).langChainService = mockLangChainService;
