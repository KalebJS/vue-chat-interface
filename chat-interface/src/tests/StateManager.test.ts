...
import { type Message, MessageStatus, ModelProvider, MemoryType, ChainType } from "../types";
...
describe("StateManager", () => {
    ...
    describe("LangChain Synchronization", () => {
        ...
        it("should handle LangChain errors gracefully", async () => {
            vi.mocked(mockLangChainService.isInitialized).mockReturnValue(true);
            vi.mocked(mockLangChainService.getConversationHistory).mockRejectedValue(new Error("LangChain error"));
    ...
    describe("Streaming functionality", () => {
        beforeEach(() => {
            vi.mocked(mockLangChainService.isInitialized).mockReturnValue(true);
            vi.mocked(mockLangChainService.sendMessageStreaming).mockImplementation(async (_message, options) => {
