...
describe("Performance Tests for Long Conversations and Memory Usage", () => {
    it("should handle large conversation histories efficiently", async () => {
        ...
        expect(
            screen.getByText(
                "Message 999: This is a test message with some content to simulate real conversation data.",
            ),
        ).toBeInTheDocument();
    });
    ...
    it("should handle streaming performance with long responses", async () => {
        ...
        const longResponse =
            "This is a very long response that simulates a detailed AI answer with multiple paragraphs and extensive content. ".repeat(
                100,
            );
