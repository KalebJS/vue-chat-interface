...
describe('Performance Integration Tests', () => {
  ...
  describe('Large Conversation History Performance', () => {
    ...
    it('should handle conversation search and filtering efficiently', async () => {
      ...
      const filteredMessages = searchableConversation.filter(msg => 
  ...
  describe('Streaming Performance', () => {
    it('should handle high-frequency streaming updates efficiently', async () => {
      ...
      mockLangChainService.sendMessageStreaming.mockImplementation(async (message, options) => {
        const response = 'This is a very long streaming response that will be sent token by token to test the performance of the streaming implementation. '.repeat(20);
