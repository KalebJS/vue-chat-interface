...
export const AudioControls: React.FC<AudioControlsProps> = ({
    ...
    const controlsClasses = ["audio-controls", className, audioState?.isSupported ? "supported" : "unsupported"]
        .filter(Boolean)
        .join(" ");
    ...
    return (
        <div className={controlsClasses} role="group" aria-label="Audio playback controls">
            <button
                ...
                title={isThisMessagePlaying ? "Pause audio" : isThisMessagePaused ? "Resume audio" : "Play audio"}
                type="button"
            >
